...
const create = (function(){
  ...
  function createLi(li,ul,id) {
    ...
    row.innerHTML =
    `<span class="name_column">I ate a <strong>${li.name}</strong></span>
     <span class="calories_column">what contains <strong>${li.calories}</strong> kcal</span>
     <span class="date_column"> at <strong>${date}</strong></span>`
    return row
  }
